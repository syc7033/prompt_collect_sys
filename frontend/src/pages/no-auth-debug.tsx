...
// 这是一个不使用Layout组件的调试页面，完全绕过身份验证
const NoAuthDebugPage: React.FC = () => {
  useEffect(() => {
    // 打印调试信息
    console.log('无认证调试页面加载');
  ...
  return (
    <>
      <Head>
        <title>无认证调试页面 - AI提示词知识库</title>
        <meta name="viewport" content="width=device-width, initial-scale=1" />
        <meta httpEquiv="Content-Language" content="zh-CN" />
      </Head>
      
      <div style={{ padding: '20px', maxWidth: '1200px', margin: '0 auto' }}>
        <Title level={1}>无认证调试页面</Title>
        <Paragraph>这是一个用于调试布局和样式问题的页面，不使用Layout组件，完全绕过身份验证。</Paragraph>
...
export default NoAuthDebugPage;
